...
public class CriptografiaRSA {
    ...
    private void gerarNovasChaves() throws Exception {
        ...
        // Para didática: primos de 4 dígitos (seguros o suficiente)
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("\n🔒 TESTE DE CRIPTOGRAFIA RSA:");
        System.out.println("Senha original: " + senhaTeste);
        
        rsa.mostrarPassosCriptografia(senhaTeste);
        
        String senhaCriptografada = rsa.criptografar(senhaTeste);
        System.out.println("\nSenha criptografada: " + senhaCriptografada);
        
        String senhaDescriptografada = rsa.descriptografar(senhaCriptografada);
        System.out.println("Senha descriptografada: " + senhaDescriptografada);
        
        System.out.println("\n✅ Teste " + (senhaTeste.equals(senhaDescriptografada) ? "PASSOU" : "FALHOU"));
    }
}