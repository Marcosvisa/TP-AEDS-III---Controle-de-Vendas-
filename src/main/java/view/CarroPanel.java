...
btnIncluir.addActionListener(e -> incluirCarro());  
...
painelBusca.add(btnBuscarModelo);
        ...
        tabelaCarros.getColumnModel().getColumn(1).setPreferredWidth(150); 
        tabelaCarros.getColumnModel().getColumn(2).setPreferredWidth(150); 
        tabelaCarros.getColumnModel().getColumn(3).setPreferredWidth(100); 
        tabelaCarros.getColumnModel().getColumn(4).setPreferredWidth(100); 
